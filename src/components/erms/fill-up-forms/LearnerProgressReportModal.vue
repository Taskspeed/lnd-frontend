  ...
  <q-dialog v-model="show" maximized-mobile>
    <q-card class="lpr-modal">
      ...
      <q-card-section class="lpr-header">
        <img src="/public/image/header" alt="" class="lpr-header-img" />
      ...
      <q-card-section class="lpr-body">
        ...
        <div class="lpr-field-row">
          ...
          <span class="lpr-field-line"></span>
        </div>
        <div class="lpr-field-row">
        ...
        <div class="lpr-grid-3">
          ...
          <div class="lpr-box">
            ...
            <q-checkbox dense v-model="technicalAreas" val="Attention to Detail" label="Attention to Detail" />
          </div>
          <div class="lpr-box">
          ...
          <tbody>
            <tr v-for="item in competencyList" :key="item">
              ...
              <td v-for="n in 5" :key="n" class="lpr-rating-cell">
                <q-radio dense v-model="ratings[item]" :val="6 - n" />
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <div class="lpr-box lpr-box-full q-mt-md">
          ...
          <q-input dense borderless type="textarea" v-model="remarks" rows="4" class="lpr-textarea" />
        </div>
